...
alter table public.books add column if not exists media_type   text not null default 'text';   -- anime | manga | manhwa | text
...
alter table public.books add column if not exists episodes     int;
